...
* The original package name 'ujc.notificacao.system.sistema-notificacao' is invalid and this project uses 'ujc.notificacao.system.sistema_notificacao' instead.
