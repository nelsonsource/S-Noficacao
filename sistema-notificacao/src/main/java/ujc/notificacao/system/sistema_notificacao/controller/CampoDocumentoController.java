...
public class CampoDocumentoController {
    ...
    @Operation(summary = "Listar campos por documento", description = "Retorna todos os campos associados a um documento específico pelo seu ID")
    @ApiResponses(value = {
    ...
    @GetMapping("/{id}")
    @Operation(summary = "Buscar campo por ID", description = "Retorna um campo específico baseado no seu identificador")
    @ApiResponses(value = {
    ...
    @PutMapping("/{id}")
    @Operation(summary = "Atualizar campo", description = "Atualiza os dados de um campo existente pelo seu ID")
    @ApiResponses(value = {
    ...
    @DeleteMapping("/{id}")
    @Operation(summary = "Remover campo", description = "Remove um campo do sistema pelo seu ID")
    @ApiResponses(value = {
